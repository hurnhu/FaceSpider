                                                                           ...
                                                                           <div class="row">
                                                                                       <div class="large-6 medium-6 columns">
                                                                                                   ...
                                                                                                   <input type="radio" name="ao" value="0"
                                                                                                           <?php if($like->getValue() == 1) {
                            echo "checked";
                        } ?>><label for="Pick from Likes">Pick
                from likes
                only </label>
                </br>
                <input type="radio" name="ao" value="1"
<?php if($comment->getValue() == 1) {
        echo "checked";
    } ?>><label for="Pick from Comments">Pick
                from comments
                only </label>
                </br>

<input type="radio" name="ao" value="2"  <?php if($or->getValue() == 1) {
        echo "checked";    //($_REQUEST['ao'] == 0) ? print'checked' : "" ?>><label
    }
>like OR comment</label>
</br>
<input type="radio" name="ao" value="3"  <?php if($and->getValue() == 1) {
    echo "checked";    //($_REQUEST['ao'] == 1) ? print'checked' : "" ?>><label
}
